...
class DS3231(_BaseRTC):
    ...
    def control(self):
        return self._register(self._CONTROL_REGISTER, buffer=None)
...
#   R2 29Sep2021 Added so that both alarm flags can be cleared with one function call
    def no_alarmflag(self):
        return self._flag(self._STATUS_REGISTER, 0b00000011, 0)
